...
export const blogPosts = [
  ...
  {
    slug: "intelbras-sistema-alarme-incendio-nbr-17240",
    title: "Intelbras e os Sistemas de Alarme de Incêndio: Tecnologia Nacional Conforme NBR 17240",
    excerpt: "Conheça o portfólio de centrais e detectores de fumaça da Intelbras, primeira fabricante brasileira certificada conforme ABNT NBR 7240, e entenda como escolher o sistema correto para sua edificação.",
    date: "2024-04-10",
    readTime: "9 min",
    category: "Alarme de Incêndio",
    keywords: ["Intelbras alarme incêndio", "detector fumaça Intelbras", "central alarme endereçável", "NBR 17240"],
    image: "https://images.unsplash.com/photo-1558618666-fcd25c85cd64?w=800&q=80",
  },
  {
    slug: "bral-bralarmseg-sistemas-deteccao-industrial",
    title: "Bralarmseg (Bral): Sistemas de Detecção de Incêndio para Ambientes Industriais",
    excerpt: "A Bralarmseg é referência em sistemas de alarme de incêndio para indústrias e áreas classificadas. Conheça suas centrais endereçáveis, sirenes de longo alcance e certificações EN 54-3.",
    date: "2024-04-05",
    readTime: "8 min",
    category: "Alarme de Incêndio",
    keywords: ["Bral alarme incêndio", "Bralarmseg", "sirene industrial incêndio", "EN 54-3"],
    image: "https://images.unsplash.com/photo-1504328345606-18bbc8c9d7d1?w=800&q=80",
  },
  {
    slug: "segurimax-sistema-sem-fio-max-fi-retrofit",
    title: "Segurimax MAX-FI: Sistema de Alarme de Incêndio Sem Fio para Retrofit",
    excerpt: "O sistema sem fio MAX-FI da Segurimax elimina a necessidade de cabeamento em edificações prontas. Saiba como funciona, onde é indicado e como atende à ABNT NBR 17240.",
    date: "2024-03-30",
    readTime: "8 min",
    category: "Alarme de Incêndio",
    keywords: ["Segurimax MAX-FI", "alarme incêndio sem fio", "retrofit alarme", "ABNT NBR 17240"],
    image: "https://images.unsplash.com/photo-1558618666-fcd25c85cd64?w=800&q=80",
  },
  {
    slug: "ascael-40-anos-deteccao-incendio-classe-a",
    title: "Ascael: 40 Anos de Excelência em Detecção de Incêndio com Tecnologia Classe A",
    excerpt: "Com mais de 40 anos de mercado, a Ascael fabrica centrais endereçáveis com loop Classe A que mantém a comunicação mesmo em caso de rompimento da fiação. Entenda a tecnologia e suas vantagens.",
    date: "2024-03-25",
    readTime: "9 min",
    category: "Alarme de Incêndio",
    keywords: ["Ascael alarme incêndio", "loop Classe A", "central endereçável", "ABNT NBR 17240"],
    image: "https://images.unsplash.com/photo-1486406146926-c627a92ad1ab?w=800&q=80",
  },
  {
    slug: "skyfire-sistema-hibrido-analogico-incendio",
    title: "SKYFIRE: O Primeiro Sistema Híbrido Analógico de Detecção de Incêndio do Brasil",
    excerpt: "A SKYFIRE foi pioneira no Brasil ao lançar um sistema híbrido que integra dispositivos cabeados e wireless em uma única central. Conheça a tecnologia, certificações EN 54 e aplicações práticas.",
    date: "2024-03-20",
    readTime: "9 min",
    category: "Alarme de Incêndio",
    keywords: ["SKYFIRE alarme incêndio", "sistema híbrido incêndio", "EN 54", "detector fumaça wireless"],
    image: "https://images.unsplash.com/photo-1558618666-fcd25c85cd64?w=800&q=80",
  },
  {
  ...
  {
    slug: "sistemas-pre-engenheirados-incendio-o-que-sao",
    title: "Sistemas Pré-Engenheirados de Combate a Incêndio: O que São e Quando Usar",
    excerpt: "Entenda a diferença entre sistemas pré-engenheirados e projetados, quando cada um é obrigatório, quais normas são aplicáveis e como escolher o sistema correto para sua aplicação industrial.",
    date: "2026-04-01",
    readTime: "10 min",
    category: "Sistemas Pré-Engenheirados",
    keywords: ["sistema pré-engenheirado incêndio", "FireDETEC", "Amerex", "NFPA 17", "supressao automatica industrial"],
    image: "https://images.unsplash.com/photo-1581092160607-ee22621dd758?w=800&q=80",
  },
  {
    slug: "firedetek-tubo-detector-linear-como-funciona",
    title: "FireDETEC: Como Funciona o Tubo Detector Linear e Por que é o Futuro da Proteção Industrial",
    excerpt: "O tubo detector linear da Rotarex FireDETEC é simultaneamente sensor e agente extintor. Entenda o princípio de funcionamento, as vantagens sobre detectores elétricos e as aplicações típicas em máquinas CNC, painéis elétricos e veículos.",
    date: "2026-04-01",
    readTime: "9 min",
    category: "Sistemas Pré-Engenheirados",
    keywords: ["FireDETEC", "tubo detector linear", "Rotarex", "supressao automatica CNC", "sistema extinção painel elétrico"],
    image: "https://images.unsplash.com/photo-1565008447742-97f6f38c985c?w=800&q=80",
  },
  {
    slug: "amerex-dry-ics-protecao-veiculos-off-road",
    title: "Amerex Dry-ICS: O Sistema que Protege Mineradoras e Construção Civil contra Incêndio",
    excerpt: "O sistema Dual Agent Dry-ICS da Amerex combina pó químico para knockdown imediato e agente ICS para resfriamento e prevenção de re-ignição. Entenda por que é o padrão da indústria para veículos off-road.",
    date: "2026-04-01",
    readTime: "8 min",
    category: "Sistemas Pré-Engenheirados",
    keywords: ["Amerex Dry-ICS", "proteção veículo mineradora", "sistema extinção escavadeira", "dual agent fire suppression", "incêndio veículo off-road"],
    image: "https://images.unsplash.com/photo-1558618666-fcd25c85cd64?w=800&q=80",
  },
  {
    slug: "agente-limpo-fk-5-1-12-novec-1230-painel-eletrico",
    title: "FK-5-1-12 (Novec 1230) vs HFC-227ea: Qual Agente Limpo Escolher para Painéis Elétricos?",
    excerpt: "Comparação técnica entre FK-5-1-12 (Novec 1230) e HFC-227ea (FM-200) para proteção de painéis elétricos. Eficácia, impacto ambiental, custo e regulamentação. Qual escolher em 2026?",
    date: "2026-04-01",
    readTime: "8 min",
    category: "Agentes Extintores",
    keywords: ["FK-5-1-12", "Novec 1230", "HFC-227ea", "FM-200", "agente limpo painel elétrico", "NFPA 2001"],
    image: "https://images.unsplash.com/photo-1581092160607-ee22621dd758?w=800&q=80",
  },
  {
    slug: "water-mist-fogmaker-onibus-caminhao-resolucao-contran",
    title: "Water Mist em Ônibus e Caminhões: Resolução CONTRAN 697/2017 e o Sistema Fogmaker",
    excerpt: "A Resolução CONTRAN 697/2017 exige sistema de supressao de incêndio em ônibus com mais de 20 lugares. Entenda o que é o sistema Water Mist Fogmaker, como funciona e como regularizar sua frota.",
    date: "2026-04-01",
    readTime: "7 min",
    category: "Sistemas Pré-Engenheirados",
    keywords: ["water mist ônibus", "Fogmaker", "CONTRAN 697", "sistema extinção ônibus", "proteção incêndio ônibus"],
    image: "https://images.unsplash.com/photo-1544620347-c4fd4a3d5957?w=800&q=80",
  },
  {
    slug: "protecao-incendio-laboratorio-chapel-exaustao-nfpa-45",
    title: "Proteção contra Incêndio em Laboratórios: Capelas de Exaustão e NFPA 45",
    excerpt: "Capelas de exaustão concentram vapores inflamáveis e fontes de ignição. Entenda como o FireDETEC Fume Hood protege capelas de laboratório, quais agentes são adequados e o que diz a NFPA 45.",
    date: "2026-04-01",
    readTime: "8 min",
    category: "Sistemas Pré-Engenheirados",
    keywords: ["proteção incêndio laboratório", "chapel exaustão incêndio", "FireDETEC fume hood", "NFPA 45", "supressao laboratório"],
