 ...
 * Opções: copiar link, WhatsApp, E-mail
 */
...
export default function ShareButton({ slug, baseUrl, trigger }: ShareButtonProps) {
  ...
  const handleCopy = async () => {
    try {
      ...
      setCopied(true);
      toast.success("Link copiado! O link do laudo foi copiado para a área de transferência.");
  ...
  const handleEmail = () => {
    const subject = encodeURIComponent("Laudo Técnico OPERIS IA");
